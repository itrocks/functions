 ...
 * @link https://it.rocks/reference/functions/string
 */
 ...
 * @return boolean
 */
function beginsWith(array|string $haystack, array|string $needle) : bool
{
 ...
 * @return boolean
 */
function endsWith(array|string $haystack, array|string $needle) : bool
{
	if (is_array($haystack)) {
 ...
 * @return int
 */
function rowCount(string $string) : int
{
 ...
 * @param $joker    string|null if set, replace refused characters with this one
 * @return string
 */
function strSimplify(
	string $string, array|bool|string $extended = false, string $joker = null
) : string
{
	$result = '';
	if ($extended && !is_string($extended)) {
		$extended = is_array($extended) ? join('', $extended) : '.,/- ';
	}
 ...
 *
 * @param $string string
 * @param $joker  string|null if set, replace refused characters with this one instead of removing it
 * @return string
 */
function strUri(string $string, string $joker = null) : string
{
...
/**
 * @param $string string
 * @param $joker  string|null
 * @return string
 */
function strUriElement(string $string, string $joker = null) : string
{
